            ...
            <div class="carousel-item active">
                <div class="d-block w-100 my-5" >
                    ...
                    <section>
                        <hr>
                        <div class="row mt-5">
                            <div class="col-md-3 col-sm-6 bottom-margin text-center counter-section sm-margin-bottom-ten">
                                <i
                                        class="fa fa-birthday-cake medium-icon"></i> <span
                            ...
                            <div class="col-md-3 col-sm-6 bottom-margin text-center counter-section sm-margin-bottom-ten">
                                <i
                                        class="fa fa-calendar medium-icon"></i> <span class="counter-number"></span>
                                <span
                                        class="timer counter">${projectsProductivity}</span>
                                <p class="counter-title"><fmt:message bundle="${loc}"
                                                                      key="local.avg-project-duration"/></p>
                            </div>
                            <div class="col-md-3 col-sm-6 bottom-margin text-center counter-section sm-margin-bottom-ten">
                                <i
