...
<div class="container-xxl">
    <div class="title h1 text-center mt-3">
        <fmt:message bundle="${loc}" key="local.technical-task.create-header"/>
    </div>
            ...
            <form novalidate>
                ...
                <div class="form-group">
                    <label for="name" class="col-form-label">
                        <fmt:message bundle="${loc}" key="local.technical-task.create-name"/>
                    </label>
                ...
                <div class="form-group">
                    <label for="overview" class="col-form-label">
                        <fmt:message bundle="${loc}" key="local.technical-task.create-overview"/>
                    </label>
                ...
                <label for="date" class="col-form-label">
                    <fmt:message bundle="${loc}" key="local.technical-task.create-deadline"/>
                </label>
                ...
                <div class="d-flex justify-content-center">
                    <button onclick="submitCreationForm()" type="button" class="btn btn-primary mt-3">
                        <fmt:message bundle="${loc}" key="local.technical-task.create-button"/>
                    </button>
                </div>
            </form>
        </div>
