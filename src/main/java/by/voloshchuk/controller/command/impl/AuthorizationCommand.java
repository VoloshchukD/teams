...
public class AuthorizationCommand implements Command {
    ...
    public CommandRouter execute(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if ((currentUser != null) &&
                    (currentUser.getUserDetail().getStatus()
                ...
                request.getSession().setAttribute(CommandAttribute.USER_DETAIL_ID,
                        currentUser.getUserDetail().getId());
                request.getSession().setAttribute(CommandAttribute.ROLE,
                        currentUser.getRole());
                request.getSession().setAttribute(CommandAttribute.USER_IMAGE,
                        currentUser.getUserDetail().getImagePath());
